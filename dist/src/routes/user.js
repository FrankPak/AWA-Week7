...
const userList = [];
userRouter.post('/register', (0, express_validator_1.body)("email").trim().isLength({ min: 3 }).escape(), (0, express_validator_1.body)("password").isLength({ min: 5 }), async (req, res) => {
...
userRouter.get('/api/user/list', async (req, res) => {
});
